...
total_processed_frames = {"三分之一帧数":242584}
import glob
def xyxy2xywh(x):
...
parser.add_argument('--weights', default=r"D:\采食文章部\improvedyolov10-strongsort\runs\trainFINALV10\exp\weights\best.pt", type=str, help='weights path')
parser.add_argument('--source', default=r'D:\采食文章部\yolov8_trackingdabao-SEAM\6pmnew', type=str, help='video(.mp4)path')
parser.add_argument('--project', default=ROOT / 'runs' / 'track1gpu6pm', help='save results to project/name')
...
parser.add_argument('--max_age', type=int, default=70, help='max_age')
    ...
    def write_results(self, frame_idx, txt_path, online_targets):
        with open(txt_path, 'a') as f:
            for t in online_targets:
                ...
                if x1 < 1760 and y1 > 209:
                    h = 2.50828543e-10 * x1 ** 4 - 9.64794675e-07 * x1 ** 3 + 1.23552971e-03 * x1 ** 2 - 6.27365541e-01 * x1 ** 1 + 5.42271623e+02
