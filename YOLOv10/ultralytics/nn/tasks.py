...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolov8n.yaml", ch=3, nc=None, verbose=True):  # model, input channels, number of classes
        ...
        # Build strides
        m = self.model[-1]  # Detect()
        if isinstance(m, (Detect, ASFFv10Detect, DBBv10Detect)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
            s = 640  # 2x min stride
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            DWConvTranspose2d, C3x, RepC3, C2f_ACmix, C2f_AKConv, AKConv, C2f_Context,
                 C2f_DCNv2, DCNv2, DiverseBranchBlock, C2f_DBB, C2f_DLKA, C2f_DSConv, C2f_DWRSeg, C2f_EMA, C2f_FLA,
                 C2f_iRMB, C2f_MLCA, C2f_ODConv, ODConv2d, RCSOSA, CSPStage, RepConv, RFAConv, C2f_RFAConv,
                 ...
                 PSA, SCDown, C2fMLLABlock, PSABiformer, PSAFLA, PSAMSDA, PSAEMA, PSASEAM, PSAMultiSEAM
        }:
            c1, c2 = ch[f], args[0]
            ...
            if m in {BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2f_ACmix, C2f_AKConv,
                     C2f_DCNv2, C2f_DBB, C2f_DLKA, C2f_DSConv, C2f_DWRSeg, C2f_EMA, C2f_FLA, C2f_iRMB,
                     ...
                     C2f_GhostModule_DynamicConv, C2f_UIB, C2fCIB, C2fMLLABlock, C2fCIB_iAFF, C2f_iAFF}:
        ...
        # ---------------------------------------主干----------------------------
                       ...
                       MobileNetV4HybridMedium, MobileNetV4HybridLarge, pvt_v2_b0, pvt_v2_b1, pvt_v2_b2, pvt_v2_b3,
                       pvt_v2_b4,
        ...
        # ------------------------------ASF-YOLO--------------------------------
            ...
            c2 = sum(ch[x] for x in f)
        elif m in {Detect, WorldDetect, Segment, Pose, OBB, ImagePoolingAttn, v10Detect, ASFFv10Detect, DBBv10Detect}:
