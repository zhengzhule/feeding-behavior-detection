...
parser.add_argument('--weights', default="6Unewbest.pt", type=str, help='weights path')
parser.add_argument('--source', default='6am', type=str, help='video(.mp4)path')
parser.add_argument('--project', default=ROOT / 'runs' / 'track6am', help='save results to project/name')
