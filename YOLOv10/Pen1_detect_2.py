...
total_processed_frames = {"三分之一帧数":251442}
import glob
def xyxy2xywh(x):
...
parser.add_argument('--source', default=r'D:\采食文章部\yolov8_trackingdabao-SEAM\4pmnew', type=str, help='video(.mp4)path')
        ...
        with open(txt_path, 'a') as f:
            for t in online_targets:
                ...
                #     h = 1.97605748e-10 * x1 ** 4 - 7.59015002e-07 * x1 ** 3 + 9.05807475e-04 * x1 ** 2 - 3.37221616e-01*x1 ** 1 + 4.79487679e+02
                    # 4号圈晚
                if x1 < 1700 and y1 > 222:
                    h = 1.30975295e-10 * x1 ** 4 - 4.19992686e-07 * x1 ** 3 + 3.95750521e-04 * x1 ** 2 - 8.83245803e-02 * x1 ** 1 + 4.44919556e+02
